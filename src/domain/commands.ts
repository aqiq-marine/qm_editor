...
export type Command =
  ...
  | { type: "EXTEND_BY_FRAGMENT"; fragmentName: string; targetAtomId: number; rotationAngle: number; orientation: [number, number, number] }
  | {
...
export const commandSchema = {
  oneOf: [
    ...
    { type: "object", properties: { type: { const: "EXTEND_BY_FRAGMENT" }, fragmentName: { type: "string" }, targetAtomId: { type: "number" }, rotationAngle: { type: "number" }, orientation: { type: "array", items: { type: "number" }, minItems: 3, maxItems: 3 } }, required: ["type", "fragmentName", "targetAtomId", "rotationAngle", "orientation"], additionalProperties: false },
